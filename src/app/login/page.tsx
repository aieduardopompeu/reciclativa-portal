      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-md items-center">
        <section className="w-full rounded-[1.75rem] border border-black/10 bg-white p-6 shadow-[0_18px_60px_rgba(15,23,42,0.12)] sm:p-7">
          <div className="text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-emerald-50 text-3xl font-black text-emerald-700 ring-1 ring-emerald-100">
              R
            </div>
          ...
          <div className="mt-5 text-center text-sm">
            <a href="mailto:contato@reciclativa.com" className="font-medium text-slate-600 underline underline-offset-4 hover:text-emerald-700">
