...
export const metadata: Metadata = {
  title: "Cores da coleta seletiva | Reciclativa",
  description: "Guia das cores da coleta seletiva e o que vai em cada lixeira.",
  alternates: { canonical: "/blog/cores-da-coleta-seletiva" },
};
      ...
      <div className="border-b border-slate-900">
        <div className="mx-auto w-full max-w-6xl px-4 pb-10 pt-16 sm:px-6 sm:pt-20 lg:px-8">
          ...
          <h1 className="mt-3 text-3xl font-bold leading-tight text-slate-50 sm:text-5xl">
            Coleta seletiva: cores e significados
          </h1>
          <p className="mt-4 max-w-3xl text-sm text-slate-300 sm:text-base">
            Guia rápido para separar resíduos sem confusão.
          </p>
