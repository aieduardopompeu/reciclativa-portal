...
export const metadata: Metadata = {
  title: "Tipos de reciclagem | Reciclativa",
  description: "Tipos de reciclagem: mecânica, química e energética  conceitos e exemplos.",
  alternates: { canonical: "/blog/tipos-de-reciclagem" },
};
...
<div className="border-b border-slate-900">
        <div className="mx-auto w-full max-w-6xl px-4 pb-10 pt-16 sm:px-6 sm:pt-20 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-sm text-slate-300 sm:text-base">
            Mecânica, química e energética  o que são e quando aparecem.
          </p>
