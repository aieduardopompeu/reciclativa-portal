    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <header className="mt-6 rounded-3xl border border-slate-200 bg-white p-7 shadow-sm md:p-10">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
          Por Eduardo Pompeu · Publicado em 03/12/2025
        </p>
        ...
        <article className="mx-auto max-w-none">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-slate-700">
              <li>
                <strong className="text-slate-900">Mecânica</strong> é a mais comum: separa e reprocessa
                sem alterar profundamente a química do material.
              </li>
              <li>
                <strong className="text-slate-900">Química</strong> transforma o material em insumos
                químicos (mais complexa e depende de cadeia industrial).
              </li>
              <li>
                <strong className="text-slate-900">Energética</strong> recupera energia do rejeito em
                contextos controlados; <strong className="text-slate-900">Orgânica</strong> é compostagem/biodigestão.
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <p>
              ...
              “mais usado” varia: alguns materiais vão para reciclagem mecânica, outros exigem
              processos químicos, e orgânicos seguem para compostagem ou biodigestão.
            </p>

            <h2>1) Reciclagem mecânica</h2>
            <p>
              É a mais comum no dia a dia. O material é <strong>separado</strong>,{" "}
              <strong>beneficiado</strong> e transformado fisicamente (moído, triturado, fundido e
              reprocessado) sem alterar sua estrutura química de forma profunda.
            </p>
            ...
            <p>
              ...
              transformando-o em matéria-prima química (monômeros, óleos, gases etc.). É mais complexa
              e costuma ser usada quando a reciclagem mecânica é difícil (por mistura, contaminação
              ou baixa qualidade).
            </p>
            ...
            <p>
              Na prática: muitos resíduos “até poderiam” ir para reciclagem química, mas isso depende
              de cadeia industrial. Por isso, seu papel principal é <strong>separar corretamente</strong>{" "}
            ...
            <p>
              ...
              <strong>biogás</strong> e outros subprodutos via biodigestão. É uma das formas mais eficientes
              de reduzir lixo doméstico, porque orgânicos representam uma parte grande do lixo.
            </p>
            ...
            <p>Você não precisa “adivinhar” qual reciclagem será usada. Seu foco é:</p>
            <ul>
              <li>
            ...
            <RecommendedLinks
              items={[
                ...
                },
                {
                  ...
                  description: "Tipos, símbolos e como separar corretamente.",
                },
                {
                  href: "/blog/o-que-e-reciclagem",
                  title: "O que é reciclagem",
                  description: "Conceito, etapas e por que nem tudo recicla em todo lugar.",
                },
                {
                ...
                },
                {
                  ...
                  description: "Checklist prático com exemplos e cuidados de contaminação.",
                },
              ]}
            />
          </div>
          ...
          <div className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-extrabold tracking-tight text-slate-900">
              FAQ: dúvidas comuns sobre tipos de reciclagem
            </h2>

            <div className="mt-5 space-y-5 text-sm leading-relaxed text-slate-700">
              <div>
                <h3 className="text-base font-bold text-slate-900">
                  Reciclagem mecânica é a mesma coisa que reutilização?
                </h3>
                <p className="mt-2">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900">
                  Por que alguns plásticos não são reciclados na minha cidade?
                </h3>
                <p className="mt-2">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900">Compostagem é reciclagem?</h3>
                <p className="mt-2">
