...
export const metadata: Metadata = {
  ...
  description: "Conteúdos sobre meio ambiente, impactos, soluções e educação ambiental com linguagem acessível.",
      ...
      <div className="border-b border-slate-900">
        <div className="mx-auto w-full max-w-6xl px-4 pb-10 pt-16 sm:px-6 sm:pt-20 lg:px-8">
          ...
          <h1 className="mt-3 text-3xl font-bold leading-tight text-slate-50 sm:text-5xl">
            Meio Ambiente: impactos, soluções e educação ambiental
          </h1>
          <p className="mt-4 max-w-3xl text-sm text-slate-300 sm:text-base">
            Entenda problemas e soluções ambientais, com conteúdo prático para o cotidiano.
          </p>
